...
<div class="pro_v_list_test3">
  <div class="pro_header">
    <p class="p1 floatleft">
      Product
    </p>
    <p class="p2_pr floatleft text-center">
      Price
    </p>
  ...
  <div class="sub_cart_list">
    ...
    <div class="sub_cart_con floatleft">
      ...
      <p class="p3">
        ...
        <a href="javascript:Addfavorte('{$T.post.ProductID}')" title="Add to Favourite" name="addLink">
          <img border="0" src="Themes/ecomm5/images/favoriteico.png"></img>
        </a>
      </p>
    </div>
    ...
    <div class="floatright cart_list sub_cart_jia" style="width:350px">
      <p class="p2 floatleft">
       ...
       {#if ($T.post.Item01=="")}
         <a class="p4 floatright" title="{$T.post.ProductID}" name="addCart" href="javascript:void(0);"> </a>
       {#else}
          <a href="product.aspx?pid={$T.post.ProductID}" class="p4 floatright"> </a>
        {#/if}
