...
<ul class="eof_icon_list hasStat">
	{#param name=ind value=0}
	{#foreach $T.d as post}
	<li class="wrapper" id="{$T.post.ID}">
		{#if ($T.post.Item04!="")}
		...
		<div class="clear img_description">
    ...
    <div class="img_description">
		<a href="javascript: Remove_favItem('{$T.post.ID}','{$T.post.FavFolderID}','{$T.post.ID}');">
        <img border="0" src="Themes/ecomm5/images/myeof_delete.png" title="Remove item">
		</a>&nbsp;
      <a href="javascript:void(0);" onclick="getFrame('FavoriteAdd.aspx?id={$T.post.ID}&pid={$T.post.ProductID}&favid={$T.post.FavFolderID}')" title="move to other folder"><img src="Themes/ecomm5/images/myeof_edit.png" />
      </a>
      </div>
