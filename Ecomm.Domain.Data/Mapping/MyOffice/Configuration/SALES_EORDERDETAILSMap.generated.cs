...
namespace Ecomm.Domain.Data.Mapping.MyOffice
{
    ...
    /// </summary>      
	internal partial class SALES_EORDERDETAILSMap : EntityTypeConfiguration<SALES_EORDERDETAILS>, IEntityMapper
    {
        /// <summary>
        /// Role-数据表映射构造函数
        /// </summary>
        public SALES_EORDERDETAILSMap()
        {
			SALES_EORDERDETAILSMapAppend();
        }
