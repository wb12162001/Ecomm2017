...
namespace Ecomm.Domain.Data.Mapping.MyOffice
{
    ...
    /// </summary>      
	internal partial class SALES_CONTRACTPRICEMap : EntityTypeConfiguration<SALES_CONTRACTPRICE>, IEntityMapper
    {
        /// <summary>
        /// Role-数据表映射构造函数
        /// </summary>
        public SALES_CONTRACTPRICEMap()
        {
			SALES_CONTRACTPRICEMapAppend();
        }
