...
namespace Ecomm.Domain.Data.Mapping.EpSnell
{
    ...
    /// </summary>      
	internal partial class Rela_account_locationMap : EntityTypeConfiguration<Rela_account_location>, IEntityMapper
    {
        /// <summary>
        /// Role-数据表映射构造函数
        /// </summary>
        public Rela_account_locationMap()
        {
			Rela_account_locationMapAppend();
        }
