...
namespace Ecomm.Domain.Data.Mapping.EpSnell
{
    ...
    /// </summary>      
	internal partial class Rela_account_contractpriceMap : EntityTypeConfiguration<Rela_account_contractprice>, IEntityMapper
    {
        /// <summary>
        /// Role-数据表映射构造函数
        /// </summary>
        public Rela_account_contractpriceMap()
        {
			Rela_account_contractpriceMapAppend();
        }
